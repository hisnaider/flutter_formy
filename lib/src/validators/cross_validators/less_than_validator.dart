...
/// A validator that checks if the value is less than or equal to the value of [otherField].
///
/// The [LessThanValidator] can be used with [FieldController]s holding
/// values of type `num`, `String`, `List`, `Map`, or `Set`. It ensures that
/// the value is less than or equal to the value of [otherField].
///
...
///    FieldConfig<int>(key: 'num2', validators: [LessThanValidator(otherField: 'num1')]),
///  ],
///);
///
/// // If 'num1' value = 5 and 'num2' value = 10, validation fails.
/// // If 'num1' value = 10 and 'num2' value = 5, validation passes.
/// ```
///
/// ## See also
///
...
class LessThanValidator<T> extends FormyCrossValidator<T> {
